...
def load_checkpoint(filepath):
        ...
        model_c = 25088 
        if(checkpoint['pre-model'] == 'densenet121'):
        ...
        classifier = nn.Sequential(OrderedDict([
                          ...
                          ('fc1', nn.Linear(model_c, checkpoint['hidden_layer'])),
                          ('relu', nn.ReLU()),
...
def parse():
    ...
    cl.add_argument('input_img', default='flowers/test/1/image_06752.jpg')
    cl.add_argument('checkpoint', default='checkpoint.pth')
    cl.add_argument('--top_k', default=5,type=int)
