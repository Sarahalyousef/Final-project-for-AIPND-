...
def parse():
    cl = argparse.ArgumentParser(description='Train.py')
    cl.add_argument('data_directory',default="./flowers/",type=str)
    cl.add_argument('--save_dir', default="./checkpoint.pth")
    cl.add_argument('--arch',help='densenet121 or vgg16',  default="vgg16")
    cl.add_argument('--learning_rate', default=0.001)
    cl.add_argument('--hidden_units', default=6272)
    cl.add_argument('--epochs', default=2)
